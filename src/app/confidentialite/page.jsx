    ...
    <main className="py-12 sm:py-20">
      ...
      <article className="max-w-2xl">
        ...
        <section className="mb-16">
          ...
          <div className="text-white/70 leading-relaxed space-y-4">
            ...
            <p>
              ...
              adresse IP, navigateur, pages visitées (cookies techniques uniquement).
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-white/70 leading-relaxed">
            Répondre à vos demandes. Planifier les rendez-vous. 
            Établir devis et contrats. Envoyer des rappels.
            Améliorer le site. 
        ...
        <section className="mb-16">
          ...
          <div className="text-white/70 leading-relaxed space-y-2">
            <p><span className="text-white">Consentement</span> — soumission du formulaire</p>
            <p><span className="text-white">Contrat</span> — exécution des prestations</p>
            <p><span className="text-white">Intérêt légitime</span> — sécurité et amélioration</p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="text-white/70 leading-relaxed space-y-2">
            <p>Prospects : <span className="text-white">3 ans</span> après dernier contact</p>
            <p>Clients : <span className="text-white">5 ans</span> après fin de relation</p>
            <p>Cookies : <span className="text-white">13 mois</span> maximum</p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="text-white/70 leading-relaxed space-y-2">
            <p>Vercel <span className="text-white/40">— hébergement</span></p>
            <p>Supabase <span className="text-white/40">— base de données</span></p>
            <p>Resend <span className="text-white/40">— emails transactionnels</span></p>
          </div>
